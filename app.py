...
if tabs =='Home':
        st.write(f'<h1 style="text-align: center;color:#094780;font-size:15px;">{"_Key Take Aways_ : Topics being discussed | Likes in the SKUs | Dislikes in the SKUs | Customer Sentiment | Competitive Analysis | Major Keywords | Subtopics across different automotive Key Factors"}</h1>', unsafe_allow_html=True)
