...
st.write(f'<h1 style="margin-top:-90px;color:#094780;font-size:35px;">{"Automotive Customer Review Analysis"}</h1>', unsafe_allow_html=True)
...
st.write(f'<h1 style="margin-top:-40px;color:#EC2A39;font-size:15px;">{"Turn every review into a pit stop for improvement with our Automotive Review Analysis App – where user feedback fuels your success."}</h1>', unsafe_allow_html=True)
